...
main (int argc, char *argv[])
{
  ...
  uint16_t numberOfUes = 20;	// 1
  uint16_t numberOfEnbs = 2;	// 2
...
//  NetAnim
//  AnimationInterface anim("x2-handover-msr.xml");
  
//  Ascii Trace Metrics
  AsciiTraceHelper ascii;
  p2ph.EnableAsciiAll(ascii.CreateFileStream("p2ph-msr.tr"));               // PointToPointHelper p2ph
